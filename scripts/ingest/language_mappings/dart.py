...
from scripts.ingest.language_mappings.base import MAX_CONSTANT_VALUE_LENGTH, BaseMapping
...
class DartMapping(BaseMapping):
    ...
    def __init__(self) -> None:
        ...
        super().__init__(self.__class__.__name__.lower().replace("mapping", ""))

    def get_function_query(self) -> str:
        """Get tree-sitter query pattern for Dart function definitions.

        Delegates to ConceptType.DEFINITION query to avoid duplication.
        """
        return self.get_query_for_concept(ConceptType.DEFINITION) or ""
    ...
    def get_comment_query(self) -> str:
        ...
        Delegates to ConceptType.COMMENT query to avoid duplication.
        """
        return self.get_query_for_concept(ConceptType.COMMENT) or ""
    ...
    # ConceptType interface methods

    def get_query_for_concept(self, concept: "ConceptType") -> str | None:
    ...
    def extract_content(
        ...
        if concept == ConceptType.BLOCK and "block" in captures:
            node = captures["block"]
