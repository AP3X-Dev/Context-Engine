...
from scripts.ingest.language_mappings.base import MAX_CONSTANT_VALUE_LENGTH
...
class JSFamilyExtraction:
    ...
    def extract_name(
        ...
        if concept == ConceptType.COMMENT and "definition" in captures:
            node = captures["definition"]
    ...
    def extract_metadata(
        ...
        if concept == ConceptType.DEFINITION and "definition" in captures:
            node = captures["definition"]
