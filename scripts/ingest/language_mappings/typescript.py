...
from scripts.ingest.language_mappings._shared.js_family_extraction import (
    JSFamilyExtraction,
)
...
from scripts.ingest.language_mappings.base import BaseMapping
...
class TypeScriptMapping(JSFamilyExtraction, BaseMapping):
    ...
    def get_query_for_concept(self, concept: "ConceptType") -> str | None:  # type: ignore[override]
    ...
    def create_enhanced_chunk(
        ...
        **extra_fields: Any,
        ...
        Args:
            ...
            chunk_type: Type of chunk (string: "function", "method", "property", etc.)
        ...
        if node and TREE_SITTER_AVAILABLE:
            try:
                ...
                if chunk_type in ["method", "property"]:
