...
from scripts.ingest.language_mappings.typescript import TypeScriptMapping
    ...
    def create_enhanced_chunk(
        ...
        **extra_fields: Any,
        ...
        Args:
            ...
            chunk_type: Type of chunk (string: "function", "method", "other", etc.)
        ...
        if node and TREE_SITTER_AVAILABLE:
            try:
                ...
                if chunk_type == "function" and self.is_react_component(
                    node, source
                ):
                ...
                if chunk_type == "other" and node.type in [
                    "jsx_element",
                    "jsx_self_closing_element",
                ]:
